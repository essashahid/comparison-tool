            ...
            <div class="diff-body">
                <div class="diff-grid">
                    <div class="diff-panel old">
                        <div class="panel-header">Rev4 (Previous)</div>
                        <div class="panel-content">{old_text if old_text else '<em class="empty">Not present in Rev4</em>'}</div>
                    </div>
                    <div class="diff-panel new">
                        <div class="panel-header">Rev5 (New)</div>
                        <div class="panel-content">{new_text if new_text else '<em class="empty">Not present in Rev5</em>'}</div>
                    </div>
                </div>
            </div>
        </div>
...
<body>
    <div class="hero">
        ...
        <p class="subtitle">Revision 4 → Revision 5 (2026)</p>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-label">Items in Rev4</div>
        </div>
        <div class="stat-card">
            <div class="stat-value">{stats['new_count']}</div>
            <div class="stat-label">Items in Rev5</div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="key-insight">
            <h3>📌 Key Insight</h3>
            <p>This report compares HTS Chapter 99 between Rev4 and Rev5 (2026).
...
def main():
    ...
    rev26 = load_json('Chapter 99_2026HTSRev4.json')
    ...
    print(f"   Rev4: {len(old_items)} items")
    print(f"   Rev5: {len(new_items)} items")
